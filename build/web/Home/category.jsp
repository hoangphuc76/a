    ...
    <c:forEach items="${requestScope.data}" var="category" varStatus="status">
        <li class="header__dropdown-item hideOnMobile" onmouseover="GetId(${status.index})">
        <input type="hidden" id="category_${status.index}" value="${category.product_category_id}"> ${category.product_category_name}
            ...
            <div class="header__downdown--category">
                ...
                <div class="dropdown-showbox">
                    <ul class="card-list">
                        ...
                        <li class="card-info"  id="category_detail_${status.index}">
    ...
    <!-- End 1 category o hang navbar list -->
    ...
    <!-- KET THUC DANH SACH TRONG DROPDOWN -->
